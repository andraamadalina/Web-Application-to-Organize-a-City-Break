<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CautareRestaurante.aspx.cs" Inherits="WebApplicationCityBreak.CautareRestaurante" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section style="font-family: Light 300;">
        ...
        <script>
            ...
            function displayResults(results) {
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    resultItem.innerHTML += '<br><div><a href="#container?restaurant=' + encodeURIComponent(results[i].name) + '&data= ' + data + '&ora= ' + ora + '&pers= ' + pers +'" data-target="#loginmodal4" data-toggle="modal" style="padding: 10px;background:#FF8800; border-color:#FF8800;color: white; border-radius: 5px; border-style: none; font-size: 20px;">Rezervați acum</a></div>';
                ...
                for (var i = 0; i < rezervaBtns.length; i++) {
                    rezervaBtns[i].addEventListener('click', function (event) {
                        ...
                        var restaurantName = decodeURIComponent(this.getAttribute('href').split('restaurant=')[1].split('&')[0]);
                        var restaurantNamePopup = document.getElementById('restaurantNamePopup');
                        restaurantNamePopup.innerHTML = '<h6>Detaliile programării:</h6>';
                        restaurantNamePopup.innerHTML += 'Restaurant: ' + restaurantName + '<br>';
                        restaurantNamePopup.innerHTML += 'Data: ' + data + '<br>';
                        restaurantNamePopup.innerHTML += 'Ora: ' + ora + '<br>';
                        restaurantNamePopup.innerHTML += 'Persoane: ' + pers;
                    });
                }
        ...
        <div onload="initMap()" style="margin-left: 124px; margin-right: 124px; font-family: Light 300;">
            <h1 style="color: #FF8800; margin-bottom: 20px; margin-top: 20px;">Rezultatele căutării pentru <span style="color: black;"><%= Request.QueryString["data"] %></span> la <span style="color: black;"><%= Request.QueryString["ora"] %></span> pentru <span style="color: black;"><%= Request.QueryString["pers"] %></span> persoane</h1>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div>
                                                    <p style="text-align: justify;" id="restaurantNamePopup"></p>
                                                </div>
                                            </div>
