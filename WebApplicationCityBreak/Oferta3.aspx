<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Oferta3.aspx.cs" Inherits="WebApplicationCityBreak.Oferta3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center style="font-family: Light 300; margin-top: 20px">
        ...
        <h3>Din <span style="color: #FF8800">Aeroportul Internațional Henri Coandă</span> către <span style="color: #FF8800">Aeroportul Internațional Leonardo da Vinci</span></h3>
        <hr />
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <asp:SqlDataSource runat="server" ID="ctl02" ConnectionString="<%$ ConnectionStrings:citybreakDBConnectionString3 %>"
                                        SelectCommand="SELECT [zbor_ID], [data_plecare], [ora_plecare], [ora_sosire], [aeroport_plecare_cod], [aeroport_sosire_cod] FROM [Zbor] WHERE ([aeroport_plecare_cod] = 'OTP' AND [aeroport_sosire_cod] = 'FCO') OR ([aeroport_plecare_cod] = 'FCO' AND [aeroport_sosire_cod] = 'OTP')"></asp:SqlDataSource>
                                ...
                                <center>
                                    ...
                                    <br /><br />
                                    <p>Pret dus-intors: </p>
                                    <div style="font-size: 26px; color: #FF8800;"> 325 lei</div>
